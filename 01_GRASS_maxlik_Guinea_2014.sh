...
# g.mapset location=Guinea_2014 mapset=PERMANENT
...
d.out.file output=Guinea_2014_reject format=jpg --overwrite
...
r.kappa classification=L8_2014_cluster_classes reference=L8_2014_cluster_classes output=kappa.csv -m -h --overwrite
